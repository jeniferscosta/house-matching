...
const ProductTour1 = () => {
  ...
  return (
    <View style={styles.container}>
      <ImageBackground
        source={require('../assets/ProductTour/ProdTour1.png')}
      ...
      >
        <SafeAreaView style={styles.safeArea}>
          ...
          <View style={styles.nextContainer}>
            <TouchableOpacity style={styles.button}onPress={() => navigation.navigate('ProductTour2')}>
              <Image
...
const styles = StyleSheet.create({
  container: {
    flex: 1, // Garante que o componente principal ocupa a tela inteira
  },
  background: {
    flex: 1,
    width: '100%',
